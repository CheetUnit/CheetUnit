...
//    ExecutionRequest dto = ExecutionRequestFactory.create("myMethodName", argTypes, new Object[]{"param1", 2L, 3D}, Collections.singletonList(ExecutionRequestFactory.class));
//
...
//    ExecutionRequest dto = ExecutionRequestFactory.create("myMethodName", new Class[]{String.class, Long.class, Double.class}, new Object[]{"param1", 2L, 3D}, Collections.singletonList(ExecutionRequestFactory.class));
//
//    Assertions.assertNotNull(dto.getArgs());
//    Object[] result = (Object[]) SerializationUtils.deserialize(Base64.getDecoder().decode(dto.getArgs()));
